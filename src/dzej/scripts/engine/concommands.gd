...
func sv_map(map):
	...
	var out = dzej.sceneSwtich("res://dzej/scenes/engine/GameplayWorld.tscn")
...
func reload():
	...
	dzej.msg("Reloading...")
	return dzej.sceneSwtich("res://dzej/scenes/engine/GameplayWorld.tscn")
...
func engine_reload():
	...
	get_tree().change_scene("res://dzej/scenes/engine/enginereloading.tscn")
